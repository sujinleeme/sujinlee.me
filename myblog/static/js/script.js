...
/* svg
code : http://stackoverflow.com/questions/11978995/how-to-change-color-of-svg-image-using-css-jquery-svg-image-replacement*/
$(function(){
...
$('button').on('click', 'i', function(){
	...
	// Animate Particle
	$('<div class="heart-particle part-'+rand+' '+colors[Math.floor((Math.random()*6))]+'" style="font-size:'+Math.floor(Math.random()*(28-12)+16)+'px;"><i class="fa fa-heart"></i><i class="fa fa-heart"></i></div>').appendTo('.heart-particle-box').css({animation: ""+flows[Math.floor((Math.random()*3))]+" "+timing+"s linear"});
	$('.part-'+rand).show();
	// Remove Particle
	setTimeout(function(){
	$('.part-'+rand).remove();
...
$(document).ready(function() {
	$('.likes').click(function(){
    	...
    	$.get('/like/', {post_id: id}, function(data){
...
/* modified from Rippleria Plugin
  Aauthor Nsept <nsept@ya.ru>
*/
